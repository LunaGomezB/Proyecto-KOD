...
<div class="contenedor-principal  text-center px-5 py-5 ">
    ...
    <form class="mt-4" action="ingresaru.php" method="post" style="width: 100%;">
        <div class="input-group mb-3">
         
          <input name="usuarioe" type="email" class="form-control" placeholder="Usuario o correo electrónico" aria-label="Username" aria-describedby="basic-addon1" style="width: 100%; height: 50px;">
        </div>
        <div class="input-group mb-3">
           
            <input name="contra" type="password" class="form-control" placeholder="Contraseña" aria-label="Username" aria-describedby="basic-addon1" style="width: 100%; height: 50px;">
          </div>
